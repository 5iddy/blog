...
func init() {
	proto.RegisterType((*MsgBuyName)(nil), "blog.nameservice.MsgBuyName")
	proto.RegisterType((*MsgBuyNameResponse)(nil), "blog.nameservice.MsgBuyNameResponse")
	proto.RegisterType((*MsgSetName)(nil), "blog.nameservice.MsgSetName")
	proto.RegisterType((*MsgSetNameResponse)(nil), "blog.nameservice.MsgSetNameResponse")
	proto.RegisterType((*MsgDeleteName)(nil), "blog.nameservice.MsgDeleteName")
	proto.RegisterType((*MsgDeleteNameResponse)(nil), "blog.nameservice.MsgDeleteNameResponse")
}
...
var fileDescriptor_df4dec9b515ec245 = []byte{
	...
	0x17, 0x12, 0x48, 0xca, 0xc9, 0x4f, 0xd7, 0x43, 0x92, 0x52, 0xf2, 0xe1, 0xe2, 0xf2, 0x2d, 0x4e,
	0x77, 0x2a, 0xad, 0xf4, 0x4b, 0xcc, 0x4d, 0x15, 0x92, 0xe0, 0x62, 0x4f, 0x2e, 0x4a, 0x4d, 0x2c,
	0xc9, 0x2f, 0x92, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x71, 0x85, 0x84, 0xb8, 0x58, 0x40,
	...
	,
}
...
func (c *msgClient) BuyName(ctx context.Context, in *MsgBuyName, opts ...grpc.CallOption) (*MsgBuyNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.nameservice.Msg/BuyName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetName(ctx context.Context, in *MsgSetName, opts ...grpc.CallOption) (*MsgSetNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.nameservice.Msg/SetName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteName(ctx context.Context, in *MsgDeleteName, opts ...grpc.CallOption) (*MsgDeleteNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blog.nameservice.Msg/DeleteName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_BuyName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.nameservice.Msg/BuyName",
	}
...
func _Msg_SetName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.nameservice.Msg/SetName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.nameservice.Msg/DeleteName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
